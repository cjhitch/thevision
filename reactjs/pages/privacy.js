		...
		<>
			...
			<Container as="main" fluid className={styles.main}>
				<Container>
					<Row>
						<Col>
							<Button className="mb-5" href="/" variant="primary">
								Go Back
							</Button>
							...
							<ul>
								...
								<li>
									<p>
										...
										refers to Visionary Creatives, Las Vegas
										Nevada.
									</p>
								</li>
								<li>
								...
								<li>
									<p>
										...
										Visionary Creatives, accessible from{' '}
										<a
											href="https://thevisioncreatives.com"
											rel="external nofollow noopener"
											target="_blank"
										>
											https://thevisioncreatives.com
										</a>
									</p>
								</li>
								<li>
							...
							<ul>
								...
								<li>
									...
									Cookies, please read &quot;Where can I
									change the settings for disabling, or
							...
							<ul>
								<li>
									<p>By email: info@thevisioncreatives.com</p>
								</li>
								<li>
									<p>
										By visiting this page on our website:{' '}
										<a
											href="https://thevisioncreatives.com/#contact"
											rel="external nofollow noopener"
											target="_blank"
										>
											https://thevisioncreatives.com/#contact
										</a>
									</p>
								</li>
								<li>
									<p>By phone number: 7024624682</p>
								</li>
							</ul>
						</Col>
					</Row>
